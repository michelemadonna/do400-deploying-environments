pipeline {
    ...
    environment {
        RHT_OCP4_DEV_USER = 'michele-madonna' DEPLOYMENT_STAGE = 'shopping-cart-stage' DEPLOYMENT_PRODUCTION = 'shopping-cart-production'
    }
    ...
    stages {
        ...
        stage('Build Image') {
            ...
            steps {
                ...
                -Dquarkus.container-image.tag=build-1
                '''
            }
        }
        ...
        stage('Deploy - Stage') {
            environment {
                APP_NAMESPACE = "${RHT_OCP4_DEV_USER}-dev"
